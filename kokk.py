...
# Decompiled By Dare luqman

# Youtube : https://www.youtube.com/channel/UCfZCzOUMUG74z8OQ3Qu5rdw
...
CorrectUsername = 'loqman'

CorrectPassword = 'loqman'
...
/CHANNAL SUBSCRIBE NA KIA TO OK ID NA AYA GI <::::::::::::::::[]
 ...
 whatsap :      0313XXXXXXXX

 

 You Tube :  LUQMAN KHAN OFFICIAL
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-luqman]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [Sucessfull-luqman] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [Sucessfull-luqman] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [Sucessfull-luqman]  ' + k + c + user + '  |  ' + pass3
